...
class CalendarEvent extends Page
{
    ...
    public function getCMSFields()
    {
        ...
        $this->beforeUpdateCMSFields(function ($f) use ($self) {
            ...
            $f->addFieldsToTab("Root.${recursion}", [
            ...
            $f->addFieldsToTab("Root.${recursion}", [
                OptionsetField::create('MonthlyRecursionType1', '', ['1' => _t('CalendarEvent.ONTHESEDATES', 'On these date(s)...')])->setHasEmptyDefault(true),
                CheckboxSetField::create('RecurringDaysOfMonth', '', DataList::create(RecurringDayOfMonth::class)->map('ID', 'Value')),
                OptionsetField::create('MonthlyRecursionType2', '', ['1' => _t('CalendarEvent.ONTHE', 'On the...')])->setHasEmptyDefault(true),
            ]);
