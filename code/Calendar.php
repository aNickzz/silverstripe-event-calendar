...
class Calendar extends Page
{
    ...
    public function getCMSFields()
    {
        ...
        $this->beforeUpdateCMSFields(function ($f) use ($self) {
            ...
            $f->addFieldsToTab("Root.${configuration}", [
                DropdownField::create('DefaultView', _t('Calendar.DEFAULTVIEW', 'Default view'), [
            ...
            $otherCals = Calendar::get()->exclude(['ID' => $self->ID]);
            if ($otherCals->exists()) {
    ...
    public function getEventList($start, $end, $filter = null, $limit = null, $announcement_filter = null)
    {
        ...
        $eventList = $eventList->sort(['StartDate' => 'ASC', 'StartTime' => 'ASC']);
    ...
    protected function addRecurringEvents($start_date, $end_date, $recurring_events, $all_events)
    {
        ...
        foreach ($recurring_events as $recurring_event) {
            ...
            $recurring_event_datetimes = $recurring_event->$relation()->filter([
